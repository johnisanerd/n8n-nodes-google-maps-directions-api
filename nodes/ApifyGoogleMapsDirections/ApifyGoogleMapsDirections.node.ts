...
import { properties } from './ApifyGoogleMapsDirections.properties';
import { runActor } from './helpers/executeActor';

// SNIPPET 1: Make sure the constants are correct
export const ACTOR_ID = 'czXNneHcGQ1vsxmwu' as string;

export const PACKAGE_NAME = 'n8n-nodes-google-maps-directions-api' as string;
export const CLASS_NAME = 'ApifyGoogleMapsDirections' as string;
...
export const X_PLATFORM_APP_HEADER_ID = 'google-maps-directions-app' as string;

export const DISPLAY_NAME = 'Google Maps Directions' as string;
export const DESCRIPTION =
	'Get Google Maps directions between two places with distance, duration, and route options' as string;

export class ApifyGoogleMapsDirections implements INodeType {
